...
TR_EXPORT int Compress(const uint8_t* src, const uint32_t src_size, uint8_t* dest, uint32_t dest_size, uint32_t* compressed_size);
TR_EXPORT int FreeBuffer(uint8_t* buffer);